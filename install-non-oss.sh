...
mvn install:install-file -Dfile=apache-cloudstack-java-client-1.0.9-new.jar -DgroupId=br.com.autonomiccs -DartifactId=apache-cloudstack-java-client -Dversion=1.0.9 -Dpackaging=jar
